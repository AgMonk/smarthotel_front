            ...
            <el-col :span="12">
              <el-table :data="param.edit.roles">
                ...
                <el-table-column label="移除">
                  <el-button slot-scope="scope" @click="param.edit.roles.splice(scope.$index,1)"  type="danger">移除</el-button>
                </el-table-column>
              </el-table>
            </el-col>
            <el-col :span="12">
              <el-table :data="roles">
                <el-table-column label="角色" prop="remark" :filters="filters.roles" :filter-method="filters.rolesFilter" />
